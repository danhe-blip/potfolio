    ...
    sections: [
      {
        ...
        fig: "drop image: the before wall, real screens as they were",
      },
      {
        id: "audit",
        label: "02 The Audit",
      ...
      },
      {
        ...
        body: "There was no big-bang release and no adoption campaign. The system shipped the way products ship: in increments, pulled by need, judged by whether the next screen arrived faster and matched the last one. Two products now draw from one set of parts. [Dan fills: one concrete outcome signal, like a build-speed change, engineers reaching for shared parts unprompted, or visual convergence you can point to.]",
      },
      {
        id: "next",
        label: "07 Next",
